...
public class FrmCadastroFornecedores extends javax.swing.JFrame {
    ...
    private void btnSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSairActionPerformed
        ...
        String mensagem = "Você deseja sair sem salvar os dados?";
        ...
        if (resultado == 1) {
            ...
            boolean verificadorNome = true;
            boolean verificadorTipo = true;
            boolean verificadorProduto = true;

            if (nomeFonecedor.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha o nome do Fornecedor.");
                verificadorNome = false;
            }
            if (tipoFonecedor.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha o campo CPF/CNPJ.");
                verificadorTipo = false;
            }
            if (principalProduto.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha o principal produto do forncedor.");
                verificadorProduto = false;
            }

            if (verificadorNome && verificadorProduto && verificadorTipo) {
                ...
                JOptionPane.showMessageDialog(null, "Preencha pelo menos os dados básicos do fornecedor.");
            }
